       ...
       {!!Form::open(['route'=>'vehiculos.store','method'=>'POST','enctype'=>'multipart/form-data'])!!}
            ...
            <table class="tablaReg2">
              <tr>
                ...
                <td>{!! Form::text('Nombre',null,['class'=>'form form-control','required'=>'y','autocomplete'=>'off']) !!}</td>
              </tr>
              <tr>
               <td>{!!Form::label('Descripcion','Descripción:')!!}</td>
                <td>{!! Form::text('Descripcion',null,['class'=>'form form-control','required'=>'y','autocomplete'=>'off']) !!}</td>
              </tr>
              <tr>
                <td>{!!Form::label('precioRenta','Precio de Renta:')!!}</td>
                <td>{!! Form::text('precioRenta',null,['class'=>'form form-control','required'=>'y','autocomplete'=>'off']) !!}</td>
              </tr>
              <tr>
              ...
              <tr id="desc">
                ...
                <td>{!! Form::text('Descuento',null,['class'=>'form form-control montodesc','autocomplete'=>'off']) !!}
                </td>
              </tr>
              <tr>
